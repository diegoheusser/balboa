...
public class SearchDoneAdapter extends BaseAdapter {
    ...
    public void setValues(List<Search> values) {
        this.values = values;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View view = inflater.inflate(R.layout.done_list_item, parent, false);
        TextView textViewItem = (TextView)
                view.findViewById(R.id.done_list_item_text_view_item);
        TextView textViewOldPrice = (TextView)
                view.findViewById(R.id.done_list_item_text_view_old_price);
        TextView textViewOldBrand = (TextView)
                view.findViewById(R.id.done_list_item_text_view_old_brand);
        TextView textViewOldSpecification = (TextView)
                view.findViewById(R.id.done_list_item_text_view_old_specification);
        final EditText editTextNewPrice = (EditText)
                view.findViewById(R.id.done_list_item_edit_text_new_price);
        EditText editTextNewBrand = (EditText)
                view.findViewById(R.id.done_list_item_edit_text_new_brand);
        EditText editTextNewSpecification = (EditText)
                view.findViewById(R.id.done_list_item_edit_text_new_specification);
